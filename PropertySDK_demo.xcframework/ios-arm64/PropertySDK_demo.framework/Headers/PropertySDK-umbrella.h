...
#if TARGET_PSDK
#import <PSDK-Swift.h>
#elif TARGET_PSDK_internal
#import <PSDK_internal-Swift.h>
#elif TARGET_PropertySDK_demo
#import <PropertySDK_demo-Swift.h>
#elif TARGET_PropertySDK_internal
#import <PropertySDK_internal-Swift.h>
#endif

/* Intructions:
    1) remove everything below ~25 line
    2) Build
    3) Copy contents of PropertySDK-Swift.h below with full replace like it was below line ~25 (dont forget the @imports) */
//  4) Replace all `@objc /*public*/` into `@objc /*public*/`
/*      4.1) undo replace for the line above
    5) Compile again
    6) Praise the Absolute
    7) Build for export:
        cd mobile_ios_client
        sh MiniappSDK/PropertySDK/Scripts/MakeXCFramework.sh client.xcworkspace PropertySDK ~/Desktop/PropertySDK
...
SWIFT_CLASS("_TtC16PropertySDK_demo15CBBeaconService")
...
@interface CBBeaconService (SWIFT_EXTENSION(PropertySDK_demo)) <CBPeripheralManagerDelegate>
...
@interface CBBeaconService (SWIFT_EXTENSION(PropertySDK_demo)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC16PropertySDK_demo16CBCentralService")
...
@class CBUUID;
@interface CBCentralService (SWIFT_EXTENSION(PropertySDK_demo))
...
@interface CBCentralService (SWIFT_EXTENSION(PropertySDK_demo)) <CLLocationManagerDelegate>
...
@class CBPeripheral;
@class NSNumber;
@interface CBCentralService (SWIFT_EXTENSION(PropertySDK_demo)) <CBCentralManagerDelegate>
...
SWIFT_CLASS("_TtC16PropertySDK_demo19CBPeripheralService")
...
@interface CBPeripheralService (SWIFT_EXTENSION(PropertySDK_demo)) <CBPeripheralManagerDelegate>
- (void)peripheralManagerDidUpdateState:(CBPeripheralManager * _Nonnull)peripheral;
- (void)peripheralManagerDidStartAdvertising:(CBPeripheralManager * _Nonnull)peripheral error:(NSError * _Nullable)error;
...
SWIFT_CLASS("_TtC16PropertySDK_demo23DYLDStartServiceInterop")
...
@class VoipPanelDescriptor;
@class IceServerDescriptor;
SWIFT_CLASS("_TtC16PropertySDK_demo35MiniappCordovaViewControllerInterop")
...
- (void)miniappStartMultiPaymentWithMultiPaymentID:(NSString * _Nonnull)multiPaymentID completion:(void (^ _Nonnull)(NSString * _Nonnull, NSString * _Nonnull))completion;
...
- (void)serverAuthByClientId:(NSString * _Nonnull)clientID serverURI:(NSString * _Nonnull)serverURI completion:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull))completion;
- (void)serverAuthByURL:(NSString * _Nonnull)url params:(NSDictionary<NSString *, id> * _Nonnull)params completion:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull))completion;
- (void)miniappStartOidcAuthWithUrl:(NSString * _Nonnull)url completion:(void (^ _Nonnull)(NSString * _Nullable, NSError * _Nullable))completion;
...
- (BOOL)initiateVoipWithVoipAddress:(NSString * _Nonnull)voipAddress voipLogin:(NSString * _Nonnull)voipLogin voipPassword:(NSString * _Nonnull)voipPassword voipPanels:(NSArray<VoipPanelDescriptor *> * _Nullable)voipPanels autoAnswerCall:(BOOL)autoAnswerCall iceServers:(NSArray<IceServerDescriptor *> * _Nullable)iceServers SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtCC16PropertySDK_demo35MiniappCordovaViewControllerInterop19IceServerDescriptor")
@interface IceServerDescriptor : NSObject
- (nonnull instancetype)initWithAddress:(NSString * _Nonnull)address login:(NSString * _Nullable)login password:(NSString * _Nullable)password OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtCC16PropertySDK_demo35MiniappCordovaViewControllerInterop19VoipPanelDescriptor")
@interface VoipPanelDescriptor : NSObject
- (nonnull instancetype)initWithName:(NSString * _Nullable)name type:(NSString * _Nullable)type dtmfCommand:(NSString * _Nonnull)dtmfCommand OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC16PropertySDK_demo9MiniappID")
