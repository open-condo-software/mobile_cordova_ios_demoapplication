...
module.exports = {
    ...
    // Future versions should should allow name to be optional
    // Services can be array of UUID, or on UUID (fallback to older version)
    startAdvertising: function (localName, services) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            // }
            cordova.exec(resolve, reject, 'BLEPeripheral', 'startAdvertising', [localName, services]);
        });
